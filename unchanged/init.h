...
!ccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
    ...
    integer, parameter :: Iwmaxreal = 4
    integer, parameter :: lattice_type = 1 !1: SC-3D, 2:FCC, 3: SC-2D, 4: bethe, 5: magnetic SC-2D, 6: magnetic SC-2D with more hopping
    logical, parameter :: symm = .true.
